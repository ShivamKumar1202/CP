...
function MachineCard5({machine, bg, badge}) {
    ...
    <div className={`flex flex-col rounded-md ${bg} overflow-hidden p-3 relative`}>
        <a href="#" className='relative h-50'>
           ...
           <div className='skeleton absolute inset-0' />    {/* Display a skeleton in case of slow loading*/}
            <img src='/hot press.jpg' alt="machine image"
        ...
        <div className='flex mt-1'>
            <p className='font-bold tracking-wide'> Hot Press </p>
        </div>
        <div className='flex mt-1'>
